    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-full py-16 px-6 bg-[#0a0c10]">
            <div className="mb-8 text-center">
                <h1 className="text-xl font-black tracking-tighter text-white opacity-50 italic uppercase">Neural.Protocol</h1>
            </div>

            <div className="max-w-2xl w-full glass-card p-12 rounded-[2.5rem] border border-emerald-500/20 shadow-[0_0_80px_rgba(16,185,129,0.05)] relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-slate-500 mb-10 text-sm font-medium tracking-wide">
                        Conversational AI challenge with dynamic follow-up questions. Select your difficulty level to enter the neural link.
                    </p>
            ...
            <div className="mt-12 group cursor-default">
                <p className="text-[8px] font-black text-slate-700 uppercase tracking-[1em] group-hover:text-emerald-500/40 transition-colors">AI Protocol Activated</p>
            </div>
        </div>
    );
};
